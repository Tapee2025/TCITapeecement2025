/*
  # Fix bag counting for OPC and PPC cement types

  1. Changes
    - Update monthly performance calculation to properly handle OPC (5 points) and PPC (10 points) cement
    - Fix performance metrics functions to calculate bags correctly based on cement type
    - Update triggers to handle mixed cement types properly

  2. Performance Logic
    - OPC cement: 5 points per bag
    - PPC cement: 10 points per bag
    - Legacy transactions without cement type: assume PPC (10 points per bag)
*/
