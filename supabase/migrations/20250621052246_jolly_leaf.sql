/*
  ...
  1. Changes
    ...
    - Update RLS policies to support dealer customer management
    - Add policies for dealer points requests

  2. Security
    - Dealers can view and manage customers they created
    - Dealers can create customers in their district
