...
VALUES 
  ('Welcome to the Enhanced Loyalty Program!', '<p>We\'re excited to announce several new features to enhance your experience:</p><ul><li>Real-time notifications</li><li>Achievement system</li><li>Support chat</li><li>FAQ section</li></ul><p>Explore these features and let us know what you think!</p>', 'feature', ARRAY['dealer', 'contractor'], true, 'high', now(), (SELECT id FROM users WHERE role = 'admin' LIMIT 1));