...
import { MessageCircle, Send, X, Paperclip, User, Bot, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <div 
          className={`fixed z-50 transition-all duration-300 ${
            isMinimized 
              ...
              : 'bottom-6 right-6 w-80 h-[500px] sm:w-96 sm:h-[550px]'
              ...
              {!activeTicket ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="flex-1 bg-primary-600 text-white py-2 px-3 rounded-md text-xs hover:bg-primary-700 disabled:opacity-50"
                        >
                ...
                <>
                  <div className="p-2 border-b border-gray-200 flex justify-between items-center">
                    <div>
                      <h4 className="font-medium text-xs">{activeTicket.subject}</h4>
