...
export default function NotificationCenter() {
  ...
  return (
    <div className="relative">
      ...
      {/* Notification Panel */}
      {isOpen && (
        <div className="notification-panel fixed z-50 inset-0 md:inset-auto md:fixed md:right-4 md:top-16 bg-white md:rounded-lg shadow-xl border border-gray-200 w-full md:w-96 max-h-screen md:max-h-[85vh] flex flex-col">
